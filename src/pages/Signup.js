  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 bg-gray-100">
        <div>
          <h3 className="text-4xl  text-black">Signup for an account</h3>
        </div>
          ...
          <form onSubmit={submitHandler}>
            <div>
              ...
              <div className="flex flex-col items-start">
                ...
                />
                {nameHasError && (
                  <p className="text-red-700">Please enter a first name.</p>
                )}
              </div>
            </div>
            <div className="mt-5">
            ...
            <div className="mt-5">
              ...
              <div
                className="flex items-center cursor-pointer mr-4 mb-4 text-gray-700"
