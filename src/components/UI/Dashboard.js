        ...
        loginStatus ? (
          <div className="bg-slate-100 overflow-x-scroll w-screen h-screen antialiased text-white selection:bg-blue-600 selection:text-white">
            <div className=" relative flex-1 flex flex-row min-h-0 border-r border-gray-200 pt-0">
              <div
                id="menu"
                className="bg-black min-h-screen z-10 text-white w-64 fixed left-0 h-screen overflow-y-scroll"
              >
                ...
                <div id="nav" className="w-full px-6">
                  <button
                    ...
                    value="changePass"
                    className="w-full px-2 font-bold  inline-flex space-x-2 items-center border-b border-yellow-900 py-3 bg-black hover:bg-gray-900 transition ease-linear duration-150"
                  >
                    Change password
                  </button>
                  <button
                    onClick={changeHandler}
                    value="getUser"
                    className="w-full px-2 mt-5 font-bold inline-flex space-x-2 items-center border-b border-yellow-900 py-3  bg-black hover:bg-gray-900  transition ease-linear duration-150"
                  >
                    Get User
                  </button>
                  ...
                  <button
                    onClick={changeHandler}
                    value="getBalance"
                    className="w-full px-2 mt-5 text-lg font-bold inline-flex space-x-2 items-center border-b border-yellow-900 py-3  bg-black hover:bg-gray-900  transition ease-linear duration-150"
                  >
                    Get Balance
                  </button>
                  <button
