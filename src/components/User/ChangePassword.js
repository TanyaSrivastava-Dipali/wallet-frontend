...
const ChangePassword = () => {
    ...
    const {
      ...
      const submitHandler = async(event) => {
        ...
        let response = await fetch("/api/user/changepassword",  {method: 'POST',
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex flex-col items-start">
                                <input
                                    ...
                                    className="block w-full mt-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                />
                                    {newPassHasError && <p className="text-red-700">New Password can't be empty.</p>}
                            </div>
                        </div>
                        <div className="mt-5">
                            <label
                            ...
                            <div className="flex flex-col items-start">
                                <input
                                    ...
                                    className="block w-full mt-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                />
                                    {cNewPassHasError && <p className="text-red-700">Confirm Password can't be empty.</p>}
                            </div>
                        </div>
